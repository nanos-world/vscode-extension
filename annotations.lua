...
function Pickable:AddSkeletalMeshAttached(id, skeletal_mesh_path, use_parent_bounds, use_base_leader_pose_component) end
...
---@param use_parent_bounds? boolean @If true, this component uses its parents bounds when attached. This can be a significant optimization with many components attached together (Default: true)
---@param use_base_leader_pose_component? boolean @If true, this component will use the base leader pose component for copying it's animation (Default: true)
function Pawn:AddSkeletalMeshAttached(id, skeletal_mesh_path, use_parent_bounds, use_base_leader_pose_component) end
...
---@param use_parent_bounds? boolean @If true, this component uses its parents bounds when attached. This can be a significant optimization with many components attached together (Default: true)
---@param use_base_leader_pose_component? boolean @If true, this component will use the base leader pose component for copying it's animation (Default: true)
function Vehicle:AddSkeletalMeshAttached(id, skeletal_mesh_path, use_parent_bounds, use_base_leader_pose_component) end
