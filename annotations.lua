...
---@class Trigger
---@overload fun(location: Vector, rotation: Rotator, extent: Vector|number, trigger_type?: TriggerType, is_visible?: boolean, color?: Color, overlap_only_classes?: string[]): Trigger : Entity, Actor
Trigger = {}
...
---@class Gizmo
---@overload fun(): Gizmo : Entity, Actor
Gizmo = {}
...
---@class Particle
---@overload fun(location: Vector, rotation: Rotator, asset: string, auto_destroy?: boolean, auto_activate?: boolean): Particle : Entity, Actor
Particle = {}
...
---<img src="https://github.com/nanos-world/vscode-extension/blob/master/assets/network-authority.png?raw=true" height="10"> `Network Authority`
---
...
---@class Light
---@overload fun(location: Vector, rotation?: Rotator, color?: Color, light_type?: LightType, intensity?: number, attenuation_radius?: number, cone_angle?: number, inner_cone_angle_percent?: number, max_draw_distance?: number, use_inverse_squared_falloff?: boolean, cast_shadows?: boolean, visible?: boolean, source_radius?: number): Light : Entity, Actor
Light = {}
...
---@class Billboard
---@overload fun(location: Vector, material_asset: string, size?: Vector2D, size_in_screen_space?: boolean): Billboard : Entity, Actor, Paintable
Billboard = {}
...
---@class StaticMesh
---@overload fun(location: Vector, rotation: Rotator, static_mesh_asset: string, collision_type?: CollisionType): StaticMesh : Entity, Actor, Paintable
StaticMesh = {}
...
---@class VehicleWater
---@overload fun(location: Vector, rotation: Rotator, asset: string, collision_type?: CollisionType, gravity_enabled?: boolean): VehicleWater : Entity, Actor, Vehicle, Paintable, Damageable
VehicleWater = {}
...
---@class Decal
---@overload fun(location: Vector, rotation: Rotator, material_asset: string, size?: Vector, lifespan?: number, fade_screen_size?: number): Decal : Entity, Actor, Paintable
Decal = {}
...
---@class TextRender
---@overload fun(location: Vector, rotation: Rotator, text: string, word_size?: number, color?: Color, horizontal_alignment?: TextRenderHorizontalAlignment, vertical_alignment?: TextRenderVerticalAlignment, rendering_type?: TextRenderRenderingType, font_asset?: string, cast_shadow?: boolean): TextRender : Entity, Actor
TextRender = {}
...
---@class Blueprint
---@overload fun(location: Vector, rotation: Rotator, blueprint_asset: string, collision_type?: CollisionType): Blueprint : Entity, Actor, Paintable
Blueprint = {}
...
---@class Text3D
---@overload fun(location: Vector, rotation: Rotator, text: string, scale?: Vector, color?: Color, font_type?: FontType, align_camera?: Text3DAlignCamera): Text3D : Entity, Actor, Paintable
Text3D = {}
...
---@class Melee
---@overload fun(location: Vector, rotation: Rotator, asset: string, collision_type?: CollisionType, gravity_enabled?: boolean, handling_mode?: HandlingMode, crosshair_material?: string, can_use?: boolean): Melee : Entity, Actor, Paintable, Pickable
Melee = {}
...
---@class Prop
---@overload fun(location: Vector, rotation: Rotator, asset: string, collision_type?: CollisionType, gravity_enabled?: boolean, grab_mode?: GrabMode, ccd_mode?: CCDMode): Prop : Entity, Actor, Paintable
Prop = {}
...
---@class Sound
---@overload fun(location: Vector, asset: string, is_2D_sound?: boolean, auto_destroy?: boolean, sound_type?: SoundType, volume?: number, pitch?: number, inner_radius?: number, falloff_distance?: number, attenuation_function?: AttenuationFunction, keep_playing_when_silent?: boolean, loop_mode?: SoundLoopMode, auto_play?: boolean): Sound : Entity, Actor
Sound = {}
...
---@class SceneCapture
---@overload fun(location?: Vector, rotation?: Rotator, width?: integer, height?: integer, render_rate?: number, view_distance?: number, fov_angle?: number, enable_distance_optimization?: boolean): SceneCapture : Entity, Actor
SceneCapture = {}
...
---@class Grenade
---@overload fun(location: Vector, rotation: Rotator, static_mesh_asset?: string, explosion_particles?: string, explosion_sound?: string, collision_type?: CollisionType, gravity_enabled?: boolean): Grenade : Entity, Actor, Paintable, Pickable
Grenade = {}
...
---@overload fun(location: Vector, rotation: Rotator, mesh: string|string, custom_animation_blueprint?: string, collision_type?: CollisionType, gravity_enabled?: boolean): CharacterSimple : Entity, Actor, Pawn, Paintable, Damageable
CharacterSimple = {}
...
---@overload fun(native_widget: NativeWidget): Widget : Entity
Widget = {}
...
---@class Cable
---@overload fun(location: Vector, enable_visuals?: boolean): Cable : Entity, Actor, Paintable
Cable = {}
...
---@class VehicleWheeled
---@overload fun(location: Vector, rotation: Rotator, asset: string, collision_type?: CollisionType, gravity_enabled?: boolean, auto_create_physics?: boolean, auto_unflip?: boolean, engine_sound?: string, horn_sound?: string, brake_sound?: string, engine_start_sound?: string, vehicle_door_sound?: string, auto_start_engine?: boolean, custom_animation_blueprint?: string): VehicleWheeled : Entity, Actor, Vehicle, Paintable, Damageable
VehicleWheeled = {}
...
---@class Weapon
---@overload fun(location: Vector, rotation: Rotator, asset: string, collision_type?: CollisionType, gravity_enabled?: boolean): Weapon : Entity, Actor, Paintable, Pickable
Weapon = {}
...
---@class WebUI
---@overload fun(name: string, path: string, visibility?: WidgetVisibility, is_transparent?: boolean, auto_resize?: boolean, width?: integer, height?: integer): WebUI : Entity
WebUI = {}
...
---@class Character
---@overload fun(location: Vector, rotation: Rotator, skeletal_mesh_asset: string, collision_type?: CollisionType, gravity_enabled?: boolean, max_health?: integer, death_sound?: string, pain_sound?: string): Character : Entity, Actor, Pawn, Paintable, Damageable
Character = {}
